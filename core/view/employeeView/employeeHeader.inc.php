...
require_once($_SERVER['DOCUMENT_ROOT'] . '/project/core/view/employeeView/employeeModals.inc.php');
require_once($_SERVER['DOCUMENT_ROOT'] . '/project/core/view/employeeView/employeeNav.inc.php');
