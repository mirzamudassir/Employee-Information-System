        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn btn-primary button-left-50" data-toggle="modal" data-target="#makeLeaveRequest">Leave Request</button>
                                    <!-- Advanced Tables -->
                                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Leaves Requests History
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $employeeObject->getLeavesRecordForEmployee($_SESSION['username']); ?>
                                    </tbody>
                                </table>
                            </div>
